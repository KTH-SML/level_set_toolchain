...
dWorstCase = 0.75;
% Reachable set horizon for computing avoid state set based reachable sets
TAvoidHorizon = 3;
...
shelves_zone_a = min(shelf_center, shelf_left);

% Compute avoid leave inspection zone (RCIS of inspection zone)
params = default_params;
params.label = 'grid_zone_a_avoid_outside_inspect_zone_a';
params.g = grid;
...
grid_zone_a_rcis_inspect_zone_a =  -data.value_function(:, :, :, :, end);

% Compute reach inspection goal in inspection zone
params = default_params;
params.label = 'grid_zone_a_reach_inspect_goal_a';
params.g = grid;
params.figNum = 1;
params.isBackwards = true; % BRS
params.T = 12; % seconds
params.target = shapeCylinder(params.g, [2, 4], [1.1; 0; 0.5; 0], 0.1);
params.obstacle = min(-grid_zone_a_rcis_inspect_zone_a, shelves_zone_a);
...
params = default_params;
params.label = 'grid_zone_a_avoid_shelf';
params.g = grid;
...
params.is_avoid = true;
params.T = 2;
params.target = shelves_zone_a;
params.is_avoid_colors = true;
params.isTube = true;
params.videoFilename = [save_path params.label];
data = quad_RS(params);
export_to_mat(save_path, params.label,  data);
grid_zone_a_avoid_shelf = -data.value_function(:, :, :, :, end);

% Compute reachable set for avoid shelf state set
params = default_params;
params.label = 'grid_zone_a_reach_avoid_shelf';
params.g = grid;
params.figNum = 1;
params.isBackwards = true;  % BRS
params.T = TAvoidHorizon;
params.target = grid_zone_a_avoid_shelf;
params.obstacle = shelves_zone_a;
params.is_reach_colors = true;
params.isTube = false;
params.videoFilename = [save_path params.label];
data = quad_RS(params);
...
shelves_zone_b = min(shelf_center, shelf_right);

% Compute avoid leave inspection zone (RCIS of inspection zone)
params = default_params;
params.label = 'grid_zone_b_avoid_outside_inspect_zone_b';
params.g = grid;
params.dMax = [0.0, dWorstCase, 0.0, dWorstCase]; % assume almost worst case
params.figNum = 2;
params.isBackwards = true; % BRS
...
export_to_mat(save_path, params.label,  data);
% Reuse in global grid for eventually inspection zone
grid_zone_b_rcis_inspect_zone_b =  - data.value_function(:, :, :, :, end);

% Compute reach inspection goal in inspection zone
params = default_params;
params.label = 'grid_zone_b_reach_inspect_goal_b';
params.g = grid;
params.figNum = 2;
params.isBackwards = true; % BRS
params.T = 12; % seconds
params.target = shapeCylinder(params.g, [2, 4], [1.1; 0; -0.5; 0], 0.1);
params.obstacle = min(-grid_zone_b_rcis_inspect_zone_b, shelves_zone_b);
params.is_reach_colors = true;
params.isTube = false;
params.videoFilename = [save_path params.label];
data= quad_RS(params);
...
params = default_params;
params.label = 'grid_zone_b_avoid_shelf';
params.g = grid;
params.dMax = [0.0, dWorstCase, 0.0, dWorstCase]; % assume almost worst case
params.figNum = 2;
params.isBackwards = true; % BRS
params.is_avoid = true;
params.T = 2;
params.target = shelves_zone_b;
params.is_avoid_colors = true;
params.isTube = true;
params.videoFilename = [save_path params.label];
data = quad_RS(params);
export_to_mat(save_path, params.label,  data);
grid_zone_b_avoid_shelf = -data.value_function(:, :, :, :, end);

% Compute reachable set for avoid shelf state set
params = default_params;
params.label = 'grid_zone_b_reach_avoid_shelf';
params.g = grid;
params.figNum = 2;
params.isBackwards = true;  % BRS
params.T = TAvoidHorizon;
params.target = grid_zone_b_avoid_shelf;
params.obstacle = shelves_zone_b;
params.is_reach_colors = true;
params.isTube = false;
params.videoFilename = [save_path params.label];
data = quad_RS(params);
...
params.isBackwards = true; % BRS
params.T = 12;
rcis_inspect_zone_a_global = migrateGrid(grid_zone_a, grid_zone_a_rcis_inspect_zone_a, grid');
...
params.isBackwards = true; % BRS
params.T = 12;
rcis_inspect_zone_b_global = migrateGrid(grid_zone_b, grid_zone_b_rcis_inspect_zone_b, grid');
...
% Generate dynamics forward reachable set
params = default_params;
params.label = 'dynamics';
params.g = grid;
